    ...
    <head>
        ...
        <style>
            ...
            :root {
                ...
                --kaia-primary-color: #ec4899; /* Sıcak Pembe */
                --kaia-bot-bubble: #fdf2f8; /* Açık Pembe */
                --kaia-text-color: #db2777; /* Koyu Pembe */
            }
            @media (prefers-color-scheme: dark) {
                :root {
                    ...
                    --kaia-primary-color: #f472b6; /* Açık Pembe */
                    --kaia-bot-bubble: #3f293a; /* Koyu Pembe */
            ...
            body.light-theme {
                --bg-color: #f8fafc; --card-bg: #ffffff; --history-bg: #f1f5f9; --text-color: #0f172a;
                --user-bubble: #2563eb; --bot-bubble: #f1f5f9; --primary-color: #4f46e5; --typing-color: #4f46e5;
                --border-color: #e2e8f0; --shadow-color: rgba(15, 23, 42, 0.05);
            }
            body.dark-theme {
                --bg-color: #020617; --card-bg: #0f172a; --history-bg: #1e293b; --text-color: #f1f5f9;
                --user-bubble: #3b82f6; --bot-bubble: #1e293b; --primary-color: #6366f1; --typing-color: #818cf8;
                --border-color: #334155; --shadow-color: rgba(0, 0, 0, 0.5);
            }
            /* KAIA MODU TEMASI */
            body.kaia-theme {
                background-color: var(--kaia-bot-bubble); /* Hafif Pembe Arkaplan */
                --card-bg: var(--kaia-bot-bubble);
                --history-bg: #fdf2f8; /* Kiraz Çiçeği Pembe */
                --user-bubble: #ec4899; /* Parlak Pembe */
                --bot-bubble: #ffffff;
